...
<h3 style="margin-top:26px">Как выглядит одна запись целиком</h3>
...
<p><strong>Спящий</strong> живёт в&nbsp;следствиях и&nbsp;связи не&nbsp;видит. Начальник самодур, жена холодная, рынок просел, здоровье подводит. Всё это будто погода за&nbsp;окном: случается с&nbsp;ним, а&nbsp;он&nbsp;подстраивается. Старается честно, только сделать ничего нельзя: причина каждый раз снаружи.</p>
<p><strong>Игрок</strong> связь уже почувствовал и&nbsp;взялся действовать. Меняет работу, город, партнёра, режим дня, окружение. Первые месяцы легче, а&nbsp;потом знакомое возвращается, только с&nbsp;новыми лицами и&nbsp;другим адресом. Игрок дёргает следствие, а&nbsp;корень остаётся прежним и&nbsp;переезжает вместе с&nbsp;ним. На&nbsp;этой ступени можно ходить кругами лет двадцать и&nbsp;считать это развитием.</p>
<p><strong>Творец</strong> занимается причиной, и&nbsp;это тот самый автор из&nbsp;пары выше. Его интересует состояние, с&nbsp;которым он&nbsp;зашёл в&nbsp;разговор, и&nbsp;то&nbsp;решение, что сработало раньше слов. Стоит ему сдвинуться, и&nbsp;меняется происходящее: те&nbsp;же люди отвечают иначе, знакомые сюжеты поворачиваются другой стороной.</p>
...
<h2 style="margin-top:34px">Пока объясняешь, не&nbsp;проживаешь</h2>
