...
MENU_GROUPS = [
    ...
    ("Истоки", None, [
        ...
        ("/chizhovy2/istoki/goddard/", "Невилл Годдард", "состояние уже сбывшегося"),
...
<div class="grid3" style="margin-top:26px">
<div class="card"><span class="bignum">1-2</span>{icon('layers')}<h3>Дни первые</h3><p>Разгон и&nbsp;снятие брони. Здесь становится видно, сколько сил уходило на&nbsp;поддержание образа «у&nbsp;меня всё хорошо».</p></div>
<div class="card"><span class="bignum">3</span>{icon('flame','var(--sage-deep)')}<h3>День третий</h3><p>Самый плотный. Обычно именно тут человек доходит до&nbsp;решения, которое принял двадцать или тридцать лет назад, и&nbsp;встречается с&nbsp;ним лицом к&nbsp;лицу.</p></div>
<div class="card"><span class="bignum">4-5</span>{icon('mountain','var(--sand)')}<h3>Дни последние</h3><p>Сборка нового: опора, спокойствие, договорённости с&nbsp;собой. Возвращение в&nbsp;жизнь происходит мягко, а&nbsp;не&nbsp;как выброс из&nbsp;самолёта.</p></div>
</div>
</div></section>
...
<div class="card">{icon('cups','var(--sand)')}<h3>Дома теплеет</h3><p>Часть напряжения в&nbsp;паре держалась на&nbsp;твоей половине сцепки. Убирается одна сторона, меняется вся конструкция.</p></div>
...
<section class="dark"><div class="narrow">
<h2>На чём работают участники</h2>
...
<p class="lead">Годами носить с&nbsp;тренингов инсайты в&nbsp;дом, где тебя ждёт прежний человек, дело неблагодарное. А&nbsp;можно прийти вдвоём и&nbsp;переписать общий сценарий с&nbsp;двух сторон сразу.</p></div></div>
...
<section style="padding-top:0"><div class="wrap">
<p class="eyebrow">Знакомые сюжеты</p>
<h2>С чем приходят пары</h2>
<div class="grid3" style="margin-top:26px">
<div class="card">{icon('cups')}<h3>Соседи по&nbsp;квартире</h3><p>Общий календарь, общий счёт, общие дети. Разговоры про логистику. Не&nbsp;ссоритесь, потому что&nbsp;незачем.</p></div>
...
<div class="card">{icon('speech','var(--sand)')}<h3>Стена молчания</h3><p>Он&nbsp;уходит в&nbsp;себя, она добивается ответа, он&nbsp;закрывается сильнее. Классическая сцепка, из&nbsp;которой не&nbsp;выйти уговорами.</p></div>
<div class="card">{icon('flame')}<h3>Погасла близость</h3><p>Тепло ушло в&nbsp;быт, нежность стала редкостью. Оба помнят, как было, и&nbsp;оба не&nbsp;знают, куда это делось.</p></div>
...
<div class="card">{icon('mirror','var(--sand)')}<h3>Разный темп роста</h3><p>Один меняется, другой остаётся. Расстояние растёт молча, пока однажды не&nbsp;становится слишком большим.</p></div>
</div>
</div></section>
...
<p>Если партнёр пока не&nbsp;готов, приходить одному не&nbsp;только можно, но&nbsp;и&nbsp;полезно: твоя половина сцепки в&nbsp;твоих руках, а&nbsp;шестерёнка перестаёт крутиться, когда останавливается одна из&nbsp;двух. Частые опасения на&nbsp;этот счёт разобраны на&nbsp;странице <a href="/chizhovy2/somneniya/">сомнений</a>.</p>
...
<p>Поэтому здесь не&nbsp;учат жить и&nbsp;не&nbsp;мотивируют. Вместе разбираются, откуда берётся твоя реакция и&nbsp;по&nbsp;какой причине в&nbsp;паре повторяется один сюжет. Порой непросто, порой очень точно. Но&nbsp;всегда&nbsp;по-настоящему.</p>
</div></section>
...
<div class="grid2" style="margin-top:26px">
<div class="card">{icon('mountain')}<h3>Он держит структуру</h3><p>Ведёт процесс, видит карту целиком, знает, куда идти дальше и&nbsp;где остановиться. С&nbsp;таким ведущим не&nbsp;страшно заходить далеко: дорога размечена.</p></div>
<div class="card">{icon('flame','var(--sand)')}<h3>Она держит глубину</h3><p>Чувствует, что происходит с&nbsp;человеком раньше слов, и&nbsp;идёт туда, где живое. Участники говорят про её&nbsp;работу «вскрывает и&nbsp;собирает».</p></div>
</div>
...
<p class="lead">Мы&nbsp;не&nbsp;переписываем отзывы под рекламу. Ниже живые фрагменты с&nbsp;согласия авторов. Опыт у&nbsp;каждого свой, и&nbsp;результат тоже.</p></div></div>
...
<p class="sub">Слова разные, но&nbsp;узор повторяется: сначала человек видит свою запись, потом снимает груз, потом переносит новое в&nbsp;жизнь.</p>
<div class="grid3" style="margin-top:26px">
...
<div class="card">{icon('route','var(--sand)')}<h3>Решения</h3><p class="serif" style="font-style:italic;color:var(--ink)">«Полгода не&nbsp;могла решиться на&nbsp;поездку, даже паспорт не&nbsp;находился. После работы в&nbsp;группе приняла решение внутри, и&nbsp;всё сложилось за&nbsp;день».</p></div>
...
<section class="dark"><div class="narrow">
<h2>Как мы&nbsp;обращаемся с&nbsp;отзывами</h2>
<p>Мы&nbsp;не&nbsp;переписываем слова учеников под рекламу и&nbsp;не&nbsp;заказываем тексты на&nbsp;стороне. Здесь живые фрагменты: из&nbsp;анкет после модулей, из&nbsp;рабочих чатов команд, из&nbsp;писем, которые приходят спустя год.</p>
<p>Каждый фрагмент публикуется с&nbsp;согласия автора. Имена чаще всего убираем: люди делятся личным, и&nbsp;это важнее красивой подписи. Суммы, сроки и&nbsp;скорость перемен у&nbsp;каждого свои, поэтому мы&nbsp;не&nbsp;обещаем повторения чужого результата.</p>
</div></section>
...
<p class="lead">Час живого разговора о&nbsp;твоей ситуации. Не&nbsp;продажа и&nbsp;не&nbsp;диагностика по&nbsp;чек-листу: знакомимся и&nbsp;вместе решаем, по&nbsp;пути&nbsp;ли нам. Для&nbsp;читателей сайта бесплатно.</p>
...
<div class="grid2" style="margin-top:22px">
<div class="card">{icon('target')}<h3>Сначала точка&nbsp;А</h3><p>Всё начинается с&nbsp;честного признания, где человек находится. Шаг самый трудный, и&nbsp;почти все называют его переломным.</p></div>
<div class="card">{icon('shield','var(--sage-deep)')}<h3>Потом сопротивление</h3><p>«Долго упирался», «не&nbsp;верил», «сидел и&nbsp;злился». Психика защищает привычный порядок, даже когда он&nbsp;разрушает. Так что упирался почти каждый.</p></div>
...
<div class="card">{icon('sunrise')}<h3>И только затем результаты</h3><p>Деньги, отношения, здоровье подтягиваются позже, как следствие. Ни&nbsp;одна история не&nbsp;начинается с&nbsp;них.</p></div>
</div>
<p class="note" style="margin-top:20px">Термины из&nbsp;историй разобраны в&nbsp;<a href="/chizhovy2/slovar/">словаре школы</a>.</p>
</div></section>
...
<div class="card white" style="margin:20px 0 12px">{icon('hourglass')}<h3>«Разберусь, когда станет посвободнее»</h3><p>Свободнее не&nbsp;становится: дело устроено так, что займёт ровно столько времени, сколько дашь. Пять дней погружения выглядят дорого до&nbsp;тех пор, пока не&nbsp;посчитаешь, сколько лет уже съел один и&nbsp;тот&nbsp;же круг.</p></div>
...
<div class="card white">{icon('people','var(--sand)')}<h3>«Не хочу выносить личное при чужих»</h3><p>В группе оказываются такие&nbsp;же взрослые люди с&nbsp;похожими историями, а&nbsp;личное остаётся в&nbsp;зале: это <a href="/chizhovy2/bezopasnost/">базовое правило</a>. Глубина добровольна, темп твой.</p></div>
</div></section>
...
<p class="lead">Годы в&nbsp;режиме ожидания и&nbsp;обслуживания: чтобы заметили, оценили, изменились. Здесь работа начинается с&nbsp;другого конца: с&nbsp;твоей записи, состояния и&nbsp;половины общей сцепки.</p></div></div>

<section><div class="narrow">
<h2>С чем приходят чаще всего</h2>
<div class="grid2" style="margin-top:24px">
<div class="card">{icon('loop')}<h3>Один сценарий с&nbsp;разными людьми</h3><p>Мужчины разные, финал одинаковый. Значит, дело не&nbsp;в&nbsp;них: сюжет приходит с&nbsp;тобой, и&nbsp;его можно&nbsp;переписать.</p></div>
...
<section class="dark"><div class="narrow">
<h2>Что меняется</h2>
<p>На&nbsp;сцене видно, где чувства ушли в&nbsp;тень и&nbsp;какое решение их&nbsp;там держит. Когда запись переписана, возвращается то, что было под анестезией: яркость, желания, голос. Отношения подтягиваются следом: <a href="/chizhovy2/para/" style="color:#D08A5F">даже когда работает один из&nbsp;двоих</a>.</p>
</div>
<div class="wrap"><div class="nails nails3" style="margin-top:24px">
...
<section><div class="narrow">
<h2>Три вопроса, которые звучат чаще всего</h2>
<div class="card white" style="margin:20px 0 12px">{icon('speech')}<h3>«А если муж против?»</h3><p>Так бывает часто, и&nbsp;это не&nbsp;повод отказываться от&nbsp;своей работы. Приходить одной можно и&nbsp;нужно: твоя половина общего сценария в&nbsp;твоих руках. Многие мужчины приходят вторым заходом сами, увидев перемены дома. Про совместный формат: <a href="/chizhovy2/para/">тренинг для пар</a>.</p></div>
...
<p class="lead">Без сюрпризов: вот как устроено движение от&nbsp;первого разговора до&nbsp;перемен, которые держатся. Каждый шаг добровольный, на&nbsp;любом можно остановиться.</p></div></div>
...
<p>Ядро работы: <a href="/chizhovy2/istoki/moreno-psihodrama/">живая сцена</a>. Ты&nbsp;называешь ситуацию, которая держит, группа помогает её&nbsp;построить, и&nbsp;несостоявшийся разговор наконец происходит. Рядом разборы, работа с&nbsp;состоянием и&nbsp;простые приёмы, которые уезжают с&nbsp;тобой домой.</p>
...
<div class="card white" style="margin:20px 0 12px">{icon('route')}<h3>Намерение на&nbsp;день</h3><p>Утром формулируешь не&nbsp;список дел, а&nbsp;состояние и&nbsp;фокус: «в&nbsp;моей жизни возможно только так». Желание просит, намерение спокойно&nbsp;знает. Научная опора: <a href="/chizhovy2/istoki/nauka/">исследования Голвитцера</a>.</p></div>
...
<div class="card white" style="margin-bottom:12px">{icon('ceiling','var(--sand)')}<h3>Снятие важности</h3><p>Где вцепился, там и&nbsp;заклинило: раздутая ставка включает страх. Отпустил, вернулась лёгкость: переговоры, свидания, большие решения идут иначе.</p></div>
...
<p>Ещё мы&nbsp;верим, что глубокая работа возможна без надрыва и&nbsp;без цирка. Без криков со&nbsp;сцены, без унижения ради «слома эго», без таймеров на&nbsp;оплату. Взрослому человеку достаточно честного зеркала и&nbsp;безопасного пространства, чтобы увидеть своё и&nbsp;сделать шаг.</p>
</div></section>
...
<div class="card white">{icon('speech','var(--sand)')}<h3>Честность на&nbsp;входе</h3><p>Собеседование существует, чтобы решить с&nbsp;двух сторон, твоё&nbsp;ли это место. Если видим, что нет, говорим прямо и&nbsp;советуем, куда идти.</p></div>
...
<p class="sub">Эти договорённости озвучиваются в&nbsp;первый вечер и&nbsp;действуют для всех, включая ведущих.</p>
<div class="grid3" style="margin-top:26px">
...
<div class="card">{icon('route','var(--sand)')}<h3>Право на&nbsp;паузу</h3><p>Стоп можно сказать в&nbsp;любой момент процесса. Это уважают и&nbsp;ведущие, и&nbsp;группа, без уговоров и&nbsp;объяснений.</p></div>
<div class="card">{icon('people')}<h3>Присутствие</h3><p>Телефоны в&nbsp;стороне, опоздания и&nbsp;уходы по&nbsp;делам не&nbsp;практикуются. Глубина работы держится на&nbsp;непрерывности.</p></div>
<div class="card">{icon('flame','var(--sage-deep)')}<h3>Трезвость</h3><p>Никакого алкоголя и&nbsp;веществ на&nbsp;время модуля. Работа идёт с&nbsp;тонкими состояниями, тут это принципиально.</p></div>
...
<section class="dark"><div class="narrow">
<h2>Кто отвечает за&nbsp;процесс</h2>
<p>Группу всегда ведут двое: <a href="/chizhovy2/vedushchie/" style="color:#D08A5F">Алексей и&nbsp;Ирина</a>. Один держит структуру и&nbsp;видит карту целиком, вторая идёт за&nbsp;живым и&nbsp;чувствует состояние участника раньше слов. За&nbsp;шестнадцать лет практики через их&nbsp;зал прошли десятки групп.</p>
<p>Это значит, что в&nbsp;тяжёлом процессе рядом всегда есть тот, кто видит происходящее со&nbsp;стороны и&nbsp;знает, как выводить человека обратно. Одиночная работа в&nbsp;таком формате была&nbsp;бы рискованной, и&nbsp;мы&nbsp;её&nbsp;не&nbsp;практикуем.</p>
</div></section>
{FINCTA}
""")
...
<p class="lead">Модуль заканчивается, а&nbsp;люди остаются. Люди продолжают идти вместе: практики, встречи, забеги и&nbsp;поддержка, которая работает даже в&nbsp;два часа ночи.</p></div></div>
...
<div class="card">{icon('people','var(--sage-deep)')}<h3>Поддержка на&nbsp;срыве</h3><p>Когда старая запись берёт своё, рядом есть те, кто это уже проходил и&nbsp;не&nbsp;станет утешать общими словами.</p></div>
<div class="card">{icon('target','var(--sand)')}<h3>Общие дела</h3><p>Совместные проекты, партнёрства и&nbsp;найм внутри среды: люди с&nbsp;похожими ценностями находят друг друга быстро.</p></div>
...
<div class="card white">{icon('sunrise','var(--sage-deep)')}<h3>Новое решение</h3><p>Кульминация сцены: там, где когда-то был сделан старый выбор, ты&nbsp;делаешь другой. Оно записывается так&nbsp;же глубоко, как прежнее: телом и&nbsp;эмоцией, поэтому и&nbsp;держится.</p></div>
...
<p>Самое прямое из&nbsp;всех, и&nbsp;мы&nbsp;его уважаем. Рынок тренингов приучил людей к&nbsp;обещаниям, после которых ничего не&nbsp;меняется. Недоверие тут здоровая реакция психики, признак осторожности, которая тебя не&nbsp;раз выручала.</p>
...
<p>И&nbsp;это хорошо: терапия и&nbsp;тренинг не&nbsp;соперники. Кабинетный формат идёт словами, по&nbsp;часу в&nbsp;неделю, и&nbsp;отлично собирает понимание. Здесь всё держится на&nbsp;теле и&nbsp;эмоции, в&nbsp;живой сцене, в&nbsp;погружении на&nbsp;несколько дней: другой инструмент для другого слоя.</p>
<p>То, что ты&nbsp;накопил у&nbsp;психолога, здесь превращается в&nbsp;пережитый опыт. Многие наши ученики продолжают терапию параллельно, и&nbsp;мы&nbsp;это поддерживаем.</p>
</div></section>
...
<p>Страх понятный, и&nbsp;у&nbsp;него есть основание: когда человек выходит из&nbsp;привычной роли, отношения вокруг перестраиваются. Но&nbsp;направление перемен задаёшь ты, а&nbsp;не&nbsp;тренинг. Мы&nbsp;не&nbsp;ведём к&nbsp;решениям «уходи» или «оставайся»: мы&nbsp;возвращаем способность видеть ситуацию ясно и&nbsp;выбирать спокойно.</p>
...
<p>В зале примерно поровну тех и&nbsp;других, и&nbsp;мужская часть обычно упрямее всех на&nbsp;входе и&nbsp;благодарнее всех на&nbsp;выходе. Приходят за&nbsp;ясностью в&nbsp;решениях, за&nbsp;потолком в&nbsp;деле, за&nbsp;отношениями, которые перестали работать.</p>
<p>Школу ведёт пара, и&nbsp;Алексей говорит на&nbsp;понятном языке: структура, дисциплина, дистанция, результат. <a href="/chizhovy2/dlya-predprinimatelej/">Отдельная страница для тех, кто привык тащить сам</a>.</p>
...
<section><div class="narrow">
<h2>Как проходит разговор, на&nbsp;котором всё это можно спросить</h2>
