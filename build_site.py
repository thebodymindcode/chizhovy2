...
<div class="grid2" style="margin-top:26px">
<div class="card">{icon('mountain')}<h3>Он держит структуру</h3><p>Ведёт процесс и&nbsp;видит карту целиком. Знает, куда идти дальше и&nbsp;где остановиться. С&nbsp;таким ведущим не&nbsp;страшно заходить далеко: дорога размечена.</p></div>
<div class="card">{icon('flame','var(--sand)')}<h3>Она держит глубину</h3><p>Чувствует, что происходит с&nbsp;человеком, раньше слов. Идёт туда, где живое, и&nbsp;остаётся рядом до&nbsp;конца&nbsp;процесса.</p></div>
</div>
...
<div class="card white" style="text-align:center"><h3 style="margin-bottom:4px">Метод школы</h3><p>пять притоков, одна река: 16&nbsp;лет зала, сотни историй</p></div>
</div>
</div></section>
...
<p class="lead">Сцена, состояние, погружение: у&nbsp;каждого инструмента школы есть научная подпорка. Ниже пять открытий. И&nbsp;то, как каждое из&nbsp;них живёт у&nbsp;нас в&nbsp;зале.</p></div></div>
...
<div class="card white" style="margin-bottom:12px"><h3>Питер Голвитцер: сила намерения</h3><p>Конкретно сформулированное намерение в&nbsp;разы повышает шанс действия по&nbsp;сравнению с&nbsp;простым «надо&nbsp;бы»: голове нужен не&nbsp;лозунг, а&nbsp;место, время и&nbsp;первый шаг. Наша утренняя практика на&nbsp;Марафоне стоит на&nbsp;этом&nbsp;открытии.</p></div>
<div class="card white"><h3>Мэттью Либерман: назвать, чтобы ослабить</h3><p>Названная вслух эмоция теряет силу: слова снижают активность миндалины. На&nbsp;этом держится половина работы группы. Чувство впервые получает имя и&nbsp;звучит при&nbsp;людях.</p></div>
...
<p class="lead">Люди приходят сюда с&nbsp;разным грузом. Ниже их&nbsp;пути как есть: точка&nbsp;А, сопротивление и&nbsp;то, что изменилось. Публикуем с&nbsp;согласия авторов. Результат у&nbsp;каждого&nbsp;свой.</p></div></div>
...
<div class="card">{icon('sunrise')}<h3>И только затем результаты</h3><p>Деньги, отношения, здоровье подтягиваются позже, как следствие другого состояния и&nbsp;других поступков. Ни&nbsp;одна история не&nbsp;начинается с&nbsp;них.</p></div>
</div>
...
<p class="lead">Предприниматель, пришёл весной 2024. Дальше его слова, записанные почти без правок и&nbsp;опубликованные с&nbsp;его согласия: имя он&nbsp;просил не&nbsp;раскрывать, а&nbsp;из&nbsp;неудобных мест мы&nbsp;не&nbsp;убрали ни&nbsp;одного. Результат у&nbsp;каждого свой.</p></div></div>
...
<p class="lead">У&nbsp;выпускников есть свой язык: короткие слова, за&nbsp;которыми стоят большие механизмы. Здесь перевод на&nbsp;обычный русский, чтобы группа была понятна с&nbsp;первого&nbsp;дня.</p></div></div>
...
<div class="grid2" style="margin-top:10px;margin-bottom:34px">
<div class="card white">{icon('flame')}<h3>Состояние первично</h3><p>Главная формула здесь: жизнь слушается состояния, причём быстрее, чем любых планов на&nbsp;бумаге. Меняется оно, меняются решения, за&nbsp;ними события. Ученики говорят короче: мир&nbsp;зеркалит.</p></div>
...
<p class="lead">Сильная работа возможна только там, где безопасно. Поэтому у&nbsp;школы есть границы, и&nbsp;мы&nbsp;проговариваем их&nbsp;до&nbsp;старта, а&nbsp;не&nbsp;после.</p></div></div>

<section><div class="narrow">
<h2>Три опоры безопасности</h2>
<div class="card white" style="margin:20px 0 12px">{icon('route')}<h3>Глубина добровольна</h3><p>Никто не&nbsp;вытаскивает силой: темп и&nbsp;меру открытости каждый выбирает сам. Сцена начинается, когда ты&nbsp;готов.</p></div>
...
<div class="card white">{icon('speech','var(--sand)')}<h3>Честность на&nbsp;входе</h3><p>Собеседование для того и&nbsp;нужно, чтобы решить с&nbsp;двух сторон, твоё&nbsp;ли это место. Если видим, что нет, говорим об&nbsp;этом&nbsp;сразу.</p></div>
...
<p class="lead">Модуль заканчивается, а&nbsp;люди остаются. Дальше идут вместе: практики, встречи, забеги и&nbsp;поддержка, которая работает даже в&nbsp;два часа&nbsp;ночи.</p></div></div>
