...
<h2>Ирина и&nbsp;Алексей</h2>
<div class="grid2" style="margin-top:24px">
<div class="card white">{icon('flame','var(--sand)')}<h3>Ирина</h3><p>Трансформационный тренер, больше 25&nbsp;лет работы с&nbsp;людьми. Самые глубокие программы погружения вела одна. Шесть лет готовилась к&nbsp;этому формату под руководством наставника. Участники говорят, что она «вскрывает и&nbsp;собирает», и&nbsp;вспоминают её работу&nbsp;годами.</p></div>
